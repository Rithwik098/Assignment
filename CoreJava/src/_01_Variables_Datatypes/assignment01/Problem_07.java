...
public class Problem_07 {
	public static void main(String[] agrs) {
		...
		double kmConverter = 24    / (1    + (40      / 60) + (35      / 3600))  * 1.6;
		double mintoHour = 100.35/60;

		double total = kmConverter/mintoHour;
		System.out.println("The average speed in kilometers per hour is " + total);
